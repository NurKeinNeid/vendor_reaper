...
DEBUG = False
default_manifest = ".repo/manifests/reaper_default.xml"
custom_local_manifest = ".repo/local_manifests/reaper_manifest.xml"
custom_default_revision = "8.0"
custom_dependencies = "reaper.dependencies"
org_manifest = "REAPER-Devices"  # leave empty if org is provided in manifest
org_display = "REAPER-Devices"  # needed for displaying
